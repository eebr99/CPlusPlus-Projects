...
public:
  ...
  //Postconditions: the list pointed to by listData (or testReverse for hw)
  //                attribute of UnsortedType class is a reverse of the list
  //                before the Reverse function invocation
